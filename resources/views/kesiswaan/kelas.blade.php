                                            ...
                                            <div class="grid grid-cols-5 gap-4">
                                                <div class="card">
                                                    <div class="card-body border-l-8 border-green-500">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="state">
                                                                <h3 class="text-green-500 text-lg">{{ $kelas['countHadir'] }}x</h3>
                                                        ...
                                                        <div class="progress mt-3 mb-1 !h-2 bg-green-200" style="height: 6px;">
                                                            <div class="progress-bar bg-green-500 " role="progressbar" style="width: {{ $kelas['percentageHadir'] }}%;" aria-valuenow="25"
                                                                aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                                        <div class="text-muted f12">
                                                            <span class="float-right">{{ number_format($kelas['percentageHadir']) }}%</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body border-l-8 border-cyan-500">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="state">
                                                                <h3 class="text-aqua text-lg">{{ $kelas['countSakitIzin'] }}x</h3>
                                                        ...
                                                        <div class="progress mt-3 mb-1 !h-2 bg-cyan-200" style="height: 6px;">
                                                            <div class="progress-bar bg-aqua" role="progressbar" style="width: {{ $kelas['percentageSakitIzin'] }}%;" aria-valuenow="25"
                                                                aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                                        <div class="text-muted f12">
                                                            <span class="float-right">{{ number_format($kelas['percentageSakitIzin']) }}%</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body border-l-8 border-red-700">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="state">
                                                                <h3 class="text-red-700 text-lg">{{ $kelas['countAlfa'] }}x</h3>
                                                        ...
                                                        <div class="progress mt-3 mb-1 !h-2 bg-red-200" style="height: 6px;">
                                                            <div class="progress-bar bg-red-700" role="progressbar" style="width: {{ $kelas['percentageAlfa'] }}%;"
                                                                aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                                        <div class="text-muted f12">
                                                            <span class="float-right">{{ number_format($kelas['percentageAlfa']) }}%</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body border-l-8 border-gray-400">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="state">
                                                                <h3 class="text-gray-400 text-lg">{{ $kelas['countTerlambat'] }}x</h3>
                                                        ...
                                                        <div class="progress mt-3 mb-1 !h-2 bg-gray-200" style="height: 6px;">
                                                            <div class="progress-bar bg-gray-400" role="progressbar" style="width: {{ $kelas['percentageTerlambat'] }}%;"
                                                                aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                                        <div class="text-muted f12">
                                                            <span class="float-right">{{ number_format($kelas['percentageTerlambat']) }}%</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="card">
                                                    <div class="card-body border-l-8 border-gray-900">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="state">
                                                                <h3 class="text-gray-900 text-lg">{{ $kelas['countTAP'] }}x</h3>
                                                        ...
                                                        <div class="progress mt-3 mb-1 !h-2 bg-gray-300" style="height: 6px;">
                                                            <div class="progress-bar bg-gray-900" role="progressbar" style="width: {{ $kelas['percentageTAP'] }}%;"
                                                                aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                                        <div class="text-muted f12">
                                                            <span class="float-right">{{ number_format($kelas['percentageTAP']) }}%</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
