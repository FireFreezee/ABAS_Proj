        ...
        <div class="container-fluid">
            ...
            <div class="mt-8 bg-gradient-to-t from-[#F6F7FB] from-10% to-white p-3 to-90% rounded-3xl">
                <div class="flex justify-between items-center">
                    ...
                    <form class="max-w-md mx-2" method="GET" action="{{ route('kesiswaan.siswa', ['kelas_id' => $kelas->id_kelas]) }}">
                        <div class="relative">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                    ...
                    <div class="bg-white w-full h-auto rounded-lg my-3 shadow-md border-spacing-1 border">
                        <div class="p-2">
                            <div class="flex justify-between">
                                ...
                                <a href="{{ route('kesiswaan.detail.siswa', ['id' => $student['nis']]) }}" class="flex justify-center">
                                    <button
