                    ...
                    <div class="card-body border-l-8 border-gray-400">
                        ...
                        <div class="progress mt-3 mb-1 !h-2 bg-gray-200" style="height: 6px;">
                            <div class="progress-bar bg-gray-400" role="progressbar"
                                style="width: {{ $averageAttendancePercentages['Terlambat'] }}%;" aria-valuenow="25"
                                aria-valuemin="0" aria-valuemax="100">
                            </div>
                        </div>
                        <div class="text-muted f12">
                            <span
                                class="float-right">{{ number_format($averageAttendancePercentages['Terlambat']) }}%</span>
                        </div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body border-l-8 border-gray-900">
                        ...
                        <div class="progress mt-3 mb-1 !h-2 bg-gray-300" style="height: 6px;">
                            <div class="progress-bar bg-gray-900" role="progressbar"
                                style="width: {{ $averageAttendancePercentages['TAP'] }}%;" aria-valuenow="25"
                                aria-valuemin="0" aria-valuemax="100">
                            </div>
                        </div>
                        <div class="text-muted f12">
                        ...
                        <div id="accordion-collapse-{{ $student['nis'] }}"
                            ...
                            <h2 id="accordion-collapse-heading-{{ $student['nis'] }}">
                                <button type="button"
                                    ...
                                    aria-expanded="false" aria-controls="accordion-collapse-body-{{ $student['nis'] }}">
                                            ...
                                            <div class="grid grid-cols-5 gap-4">
                                                <div class="card">
                                                    <div class="card-body border-l-8 border-green-500">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="state">
                                                                <h3 class="text-green-500 text-lg">{{ $student['attendanceCounts']['Hadir'] }}x</h3>
                                                                <p class="card-subtitle text-muted fw-500 text-xl">Hadir</p>
                                                            </div>
                                                            <div class="icon">
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                                        ...
                                                        <div class="progress mt-3 mb-1 !h-2 bg-green-200" style="height: 6px;">
                                                            <div class="progress-bar bg-green-500 " role="progressbar" style="width: {{ $student['attendancePercentages']['Hadir'] }}%;" aria-valuenow="25"
                                                                aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                                        <div class="text-muted f12">
                                                            <span class="float-right">{{ number_format($student['attendancePercentages']['Hadir']) }}%</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body border-l-8 border-cyan-500">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="state">
                                                                <h3 class="text-aqua text-lg">{{ $student['attendanceCounts']['Sakit/Izin'] }}x</h3>
                                                                <p class="card-subtitle text-muted fw-500 text-xl">Sakit/Izin</p>
                                                            </div>
                                                            <div class="icon">
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                                        ...
                                                        <div class="progress mt-3 mb-1 !h-2 bg-cyan-200" style="height: 6px;">
                                                            <div class="progress-bar bg-aqua" role="progressbar" style="width: {{ $student['attendancePercentages']['Sakit/Izin'] }}%;" aria-valuenow="25"
                                                                aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                                        <div class="text-muted f12">
                                                            <span class="float-right">{{ number_format($student['attendancePercentages']['Sakit/Izin']) }}%</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body border-l-8 border-red-700">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="state">
                                                                <h3 class="text-red-700 text-lg">{{ $student['attendanceCounts']['Alfa'] }}x</h3>
                                                                <p class="card-subtitle text-muted fw-500 text-xl">Alfa</p>
                                                            </div>
                                                            <div class="icon">
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                                        ...
                                                        <div class="progress mt-3 mb-1 !h-2 bg-red-200" style="height: 6px;">
                                                            <div class="progress-bar bg-red-700" role="progressbar" style="width: {{ $student['attendancePercentages']['Alfa'] }}%;"
                                                                aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                                        <div class="text-muted f12">
                                                            <span class="float-right">{{ number_format($student['attendancePercentages']['Alfa']) }}%</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body border-l-8 border-gray-400">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="state">
                                                                <h3 class="text-gray-400 text-lg">{{ $student['attendanceCounts']['Terlambat'] }}x</h3>
                                                                <p class="card-subtitle text-muted fw-500 text-xl">Terlambat</p>
                                                            </div>
                                                            <div class="icon">
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                                        ...
                                                        <div class="progress mt-3 mb-1 !h-2 bg-gray-200" style="height: 6px;">
                                                            <div class="progress-bar bg-gray-400" role="progressbar" style="width: {{ $student['attendancePercentages']['Terlambat'] }}%;"
                                                                aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                                        <div class="text-muted f12">
                                                            <span class="float-right">{{ number_format($student['attendancePercentages']['Terlambat']) }}%</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="card">
                                                    <div class="card-body border-l-8 border-gray-900">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="state">
                                                                <h3 class="text-gray-900 text-lg">{{ $student['attendanceCounts']['TAP'] }}x</h3>
                                                                <p class="card-subtitle text-muted fw-500 text-xl">TAP</p>
                                                            </div>
                                                            <div class="icon">
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                                        ...
                                                        <div class="progress mt-3 mb-1 !h-2 bg-gray-300" style="height: 6px;">
                                                            <div class="progress-bar bg-gray-900" role="progressbar" style="width: {{ $student['attendancePercentages']['TAP'] }}%;"
                                                                aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                                        <div class="text-muted f12">
                                                            <span class="float-right">{{ number_format($student['attendancePercentages']['TAP']) }}%</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
