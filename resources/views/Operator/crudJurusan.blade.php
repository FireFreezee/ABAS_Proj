        ...
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item active">
                    <a href=""><i class="ik ik-users"></i><span>Tambah/Edit Jurusan</span></a>
                </div>
                <div class="nav-item">
                                    ...
                                    <tr style="text-align: center;">
                                        ...
                                        <td>
                                            <div class="table-actions">
                                                <a href="#" data-toggle="modal" data-target="#edit{{$j->id_jurusan}}"><i class="ik ik-edit-2"></i></a>
                                                <a href="#" data-toggle="modal" data-target="#hapus{{ $j->id_jurusan }}"><i class="ik ik-trash-2"></i></a>
                                            </div>

                                        </td>
                                        @include('Operator.CRUDjurusanModal')
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
