        ...
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item active">
                    <a href=""><i class="ik ik-users"></i><span>Tambah/Edit Kelas</span></a>
                </div>
            </nav>
        </div>
    </div>
                                    ...
                                    <tr style="text-align: center;">
                                        ...
                                        <td>
                                            <div class="table-actions">
                                                <a href="{{ route('data-siswa', $k->id_kelas) }}"><i class="ik ik-eye"></i></a>
                                                <a href="#" data-toggle="modal" data-target="#edit{{$k->id_kelas}}"><i class="ik ik-edit-2"></i></a>
                                                <a href="#" data-toggle="modal" data-target="#hapus{{ $k->id_kelas }}"><i class="ik ik-trash-2"></i></a>
                                            </div>
